...
module.exports = {
  ...
  userID : 'lio4072',                            	// MQTT버전에서 Broker 접속을 위한 ID, 포털 ID 사용
  mqttClientId : function(){						// MQTT버전에서 Broker 접속을 위한 client ID(ex : ThingPlugID_0001)
	  var POST_FIX = '0001';
	  return this.userID+'_'+POST_FIX;
  },

  nodeID : 'pnuliuxiaodev1',         	// Device 구분을 위한 LTID, 디바이스 고유 ID 사용
  passCode : '000101',                          	// ThingPlug에 Device등록 시 사용할 Device의 비밀번호
  uKey : 'U0prUnlFZFpicHVyMFJBTXRFMUd0QkdWd2NOY09vRFZQdUpCL1lnRHVVaWZwVnRVdEJaMHZiai82U1JnallxTA==',                	// Thingplug로그인 후, `마이페이지`에 있는 사용자 인증키
